...
<div id="page-wrapper" >
         <div class="header"> 
                        ...
                        <ol class="breadcrumb">
                              ...
                              <li class="active">Request Order List</li>
                        </ol>     
         </div>
         <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Request Order List
                            <a href="{{url('add_request_order')}}"><button class="btn btn-primary" id="add_category_btn">+ Add Request Order</button></a> 
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="ro_tablelist">
                                    <thead>
                                        <tr>
                                            <th>Sr.No</th>
                                            <th>Dummy Title</th>
                                    ...
                                    <tbody>
                                       <tr>
                                         ...
                                         <td>Dummy text</td>
                                         <td>Dummy text</td>
                                         <td><a href="{{url('edit_request_order')}}"><i class='fa fa-edit text-primary mr-2'></i></a> / <a href="#"><span class='glyphicon glyphicon-trash'></span></a></td>
                                       </tr>
                                       <tr>
                                         <td>2</td>
                                         <td>Dummy text</td>
