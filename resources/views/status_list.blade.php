            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <a href="{{url('add_status')}}"><button class="btn btn-primary" id="add_category_btn">+ Add
                                Status-</button></a>
                        @endif
                    </div>
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <form method="post" style="padding: 24px;">
                        ...
                        <button type="button" class="btn btn-success light" id="inactive_btn" data-id="">Yes, Inactive
                            it! <span class="btn-icon-right"><i class="fa fa-check"></i></span></button>
                        <button type="button" class="btn btn-danger light" data-dismiss="modal" id="cancel">Cancel <span
                ...
                <div class="modal-body">
                    <form method="post">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Please enter brand name." class="form-control"
                                id="editbrand" name="editbrand" value="">



                        </div>
                        <div style="padding: 17px;">
                            <button type="button" id="editbrandbutton" class="btn btn-success mr-1">Submit <span
                                    class="btn-icon-right"><i class="fa fa-check"></i></span></button>
                            <button type="button" id="editmenu_test" class="btn btn-danger" data-dismiss="modal">Cancel
                                <span class="btn-icon-right"><i class="fa fa-close"></i></span></button>
                        </div>
                </div>
                </form>
            </div>
        ...
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <form method="post" style="padding: 24px;">
                    ...
                    <button type="button" class="btn btn-success light" id="delete_btn" data-id="">Yes, delete it! <span
                            class="btn-icon-right"><i class="fa fa-check"></i></span></button>
        ...
        $.ajax({
            ...
            if(len > 0) 
            {
                ...
                for(var i = 0; i < len; i++) 
                {
					...
					var tr_str = "<tr><td>"+id+"</td><td style='text-transform:capitalize'>"+status_name+"</td><td>"+newdate+"</td><td><label class='switch'><input type='checkbox' "+check+" id="+id+" value="+status+" onclick='getstatus("+id+")' class='statuscheckbox'><span class='slider round'></span></label></td>";
					@if(Helper::actionPermission())
					tr_str += "<td> <a href='#'  data-toggle='modal' data-target='#EditBrandModal' onclick='edit_menustatus("+id+")'><i class='fa fa-edit text-primary mr-2'></i></a> / <a href='#'  data-toggle='modal' data-target='#DeleteBrandModal' onclick='delete_menustatus("+id+")'><span class='glyphicon glyphicon-trash'></span></a></td>";
					@endif
					tr_str += "</tr>";
...
function getstatus(id) {
   ...
   // alert(status);
    ...
    if (status == 0) {
        ...
        var Url = "{{url('update_status_status')}}";
        $.ajax({
            url: Url,
            headers: {
                "X-CSRF-Token": csrfToken,
...
//Edit brand...........................................
 function edit_menustatus(id) 
 {  
        var id = id;
        var csrfToken = "{{ csrf_token() }}";

        var Url = "{{url('edit_status')}}";
        $.ajax({
            url: Url,
            headers: {
                "X-CSRF-Token": csrfToken,
...
/*--------------------Update brand name-------------------------------*/
    ...
    {        
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: "id=" + id + "&status_name=" + cat_name,
                }).done(function (response) {
                    //console.log(response);
                    if (response.code == 200) {
