                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading d-flex">
                           ...
                           <div class="d-flex">
                               <?php  if(in_array('19',Helper::addedPermission())){  ?>
    ...
    $(document).ready(function () {     
        var oTable = $('#category_tablelist').DataTable({
			...
			"rowCallback": function (nRow, aData, iDisplayIndex) {
			    ...
			    <?php	if(in_array('19',Helper::editPermission())){  ?>
				...
				<?php if(in_array('19',Helper::deletedPermission())){  ?>
				actionBtn += '&nbsp<a href="#"  data-toggle="modal" data-target="#DeleteCategoryModal" onclick="delete_menucategory('+aData.id+')"><i class="fa fa-trash text-danger mr-2"></i>Delete</a>'; 
				<?php }  ?>
...
$("#delete_btn").on("click", function () {
        ...
        var csrfToken = "{{ csrf_token() }}";
        var Url = "{{url('delete-purchase-order')}}";
        $.ajax({
            url: Url,
            headers: {
                "X-CSRF-Token": csrfToken,
