            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <a href="{{url('add_menu')}}"><button class="btn btn-primary" id="add_category_btn">+ Add
                                Menu</button></a>
                        @endif
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><label class='switch'><input type='checkbox'
                                                    ...
                                                    value="{{$row['status']}}" onclick='getstatus("{{$row['id']}}")'
                                                    class='statuscheckbox'><span class='slider round'></span></label>
                                        </td>
                                        @if(Helper::actionPermission())
                                        <td><a href='{{url("edit_menu")}}/{{$row['id']}}'><i
                                                    class='fa fa-edit text-primary mr-2'></i></a>/ <a href='#'
                                                data-toggle='modal' data-target='#DeleteModal'
                                                onclick='delete_data("{{$row['id']}}")'><i
                                                    class='fa fa-trash text-danger mr-2'></i>Delete</a> </td>
                                        @endif
                                    </tr>
                                    @endforeach
                                </tbody>
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <form method="post" style="padding: 24px;">
                        @csrf
                        <input type="hidden" name="delete_id" id="delete_id" value="">
                        <button type="button" class="btn btn-success light" id="delete_btn" data-id="">Yes, delete it!
