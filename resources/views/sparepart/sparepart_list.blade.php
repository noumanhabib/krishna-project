                    ...
                    <div class="panel panel-default">
						<div class="panel-heading d-flex">
                           ...
                           <div class="d-flex">
						    ...
						    <?php  if(in_array('16',Helper::addedPermission())){  ?>
                                       ...
                                       @if(!empty($data))
                                           @foreach ($data as $row)
                                            <tr>
												...
												@if(Helper::actionPermission())
                                                <td>
                                                 <?php   if(in_array('16',Helper::editPermission())){  ?>
                                                    <a href='{{url("edit_sparepart")}}/{{$row['id']}}'><i class='fa fa-edit text-danger mr-2'></i></a> 
