									...
									{!! Form::open(['url' =>'save_sparepart', 'class' => 'form-horizontal', 'role' => 'form']) !!}
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												  ...
												  {!! Form::select('part_color_id[]',$color_list,(isset($multiple_list) && !empty($multiple_list[0])) ? $multiple_list[0]->colour_id : '',['class'=>'form-control','required', 'id'=>'part_color_id0','tabindex'=>$tabindex++,'placeholder'=>'-Select-','onChange'=>'generateSku(0)']) !!} 
												  <span class="help-block text-danger error"></span>
											</div>
										
											<div class="col-sm-3">
												  {!! Form::label('title', 'SKU Number', ['class' => 'control-label']) !!}          
												  {!! Form::text('sku_no[]',(isset($multiple_list) && !empty($multiple_list[0])) ? $multiple_list[0]->sku_no : '',['class'=>'form-control','required', 'id'=>'sku_no0','tabindex'=>$tabindex++,'placeholder'=>'SKU Number','readonly','onBlur'=>'checkSkuNumber(this)','onKeypress'=>'submitDisable(this)','onPaste'=>'submitDisable(this)']) !!} 
												  <span class="help-block text-danger error"></span>
											</div>
											<div class="col-sm-3">
										...
										@if(count($multiple_list)>1)
											...
											<div class="form-group">												  
												<div class="col-sm-3">
													...
													{!! Form::select('part_color_id[]',$color_list,(isset($val) && !empty($val)) ? $val->colour_id : '',['class'=>'form-control','required', 'id'=>'part_color_id'.$key,'tabindex'=>$tabindex++,'placeholder'=>'-Select-','onChange'=>'generateSku('.$key.')']) !!} 
													<span class="help-block text-danger error"></span>
												</div>									
												<div class="col-sm-3">
													  {!! Form::label('title', 'SKU Number', ['class' => 'control-label']) !!}          
													  {!! Form::text('sku_no[]',(isset($val) && !empty($val)) ? $val->sku_no : '',['class'=>'form-control','required','readonly', 'id'=>'sku_no'.$key,'tabindex'=>$tabindex++,'placeholder'=>'SKU Number','onBlur'=>'checkSkuNumber(this)','onKeypress'=>'submitDisable(this)','onPaste'=>'submitDisable(this)']) !!} 
													  <span class="help-block text-danger error"></span>
												</div>
											</div>
											@endif
										...
										@endif
											...
											<input type="hidden" name="count" value="<?=count($multiple_list)?>" id="countt">
