...
<div id="page-wrapper" >
	 <div class="header"> 
		<h1 class="page-header">
			<small>Fresh Faulty Report List</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="{{url('/home')}}">Home</a></li>
			<li class="active">Fresh Faulty  Statistics Report</li>
		</ol>     
	 </div>
	 <div id="page-inner">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading d-flex">
						<div>Fresh Faulty Report </div>
						<div class="d-flex">	
							<div id="reportrange" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%">
								<i class="fa fa-calendar"></i>&nbsp;
								<span></span> <i class="fa fa-caret-down"></i>
							</div>&nbsp;&nbsp;
							<a href="{{url('download-fresh_faulty')}}"><button class="btn btn-primary button_right" id="add_category_btn">Export </button></a> 
						</div>
					</div>
                                ...
                                $fff="Failed";
                                    ...
                                    ?>
								   	<tr>
										...
										<td>{{$d->formatted_dobp}}</td>
											<td>{{$d->bname}}</td>  
										<td>{{$d->mname}}</td>  
									
										<td>{{$d->colour_name}}{{$d->els_system_id}}</td>
											<td>{{$d->sku_no}}</td>  
										<td>{{$d->part_name}}</td> 
...
// 		'serverSide': true,		
// 		"ajax":{
// 			"url": "{{url('fetch_stock_in_parts_listppf')}}"
// 		}, 	
// 		"columns": [
// 			{ data: "id" },
// 			{ data: "po_no" },
