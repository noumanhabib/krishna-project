				...
				<div class="panel panel-default">
					<div class="panel-heading d-flex">
						...
						<div class="d-flex">	
							...
							&nbsp;&nbsp;
							<a href="{{url('download-sparepart_aging')}}"><button class="btn btn-primary button_right" id="add_category_btn">Export </button></a> 
						</div>
					</div>
...
$(document).ready(function () {     
	...
	var oTable = $('#dataTableID').DataTable({
		...
		'serverSide': true,		
		"ajax":{
			"url": "{{url('fetch_stock_in_parts_lista')}}"
		}, 	
		"columns": [
			{ data: "id" },
			{ data: "formatted_dob" },
...
function cb(start, end) {
	...
	$.ajax({
		type: "POST",
		url: "{{url('set_date_range_filters')}}",
		headers: {
