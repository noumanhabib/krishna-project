...
<div id="page-wrapper" >
	 <div class="header"> 
		<h1 class="page-header">
			<small>Extra Part Report List</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="{{url('/home')}}">Home</a></li>
			<li class="active">Extra Part  Report</li>
		</ol>     
	 </div>
	 <div id="page-inner">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading d-flex">
						<div>Extra Part Report </div>
						<div class="d-flex">	
							<div id="reportrange" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%">
								<i class="fa fa-calendar"></i>&nbsp;
								<span></span> <i class="fa fa-caret-down"></i>
							</div>&nbsp;&nbsp;
							<a href="{{url('download-extra_part')}}"><button class="btn btn-primary button_right" id="add_category_btn">Export </button></a> 
						</div>
					</div>
						...
						<div class="table-responsive" id="dvData">
							...
							<?php 
							 $usersddfio = DB::table('els_system_status_log')
                                    ...
                                    if($usersddfio>0)
                                    {
                                    $date=date('Y-m-d h:i:s',strtotime($d->formatted_dob));  
...
// 		'serverSide': true,		
// 		"ajax":{
// 			"url": "{{url('fetch_stock_in_parts_listppe')}}"
// 		}, 	
// 		"columns": [
// 			{ data: "id" },
// 			{ data: "formatted_dob" },
...
function cb(start, end) {
	...
	$.ajax({
		type: "POST",
		url: "{{url('set_date_range_filterppe')}}",
		headers: {
