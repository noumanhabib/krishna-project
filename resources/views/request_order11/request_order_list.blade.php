           ...
           var len = 0;
            ...
            if(len > 0) 
            {
                ...
                {    
                     ...
                     var tr_str="<tr><td>"+num_increment+"</td><td style='text-transform:capitalize'>"+brand_name+"</td><td style='text-transform:capitalize'>"+model_name+"</td><td style='text-transform:capitalize'>"+type+"</td><td style='text-transform:capitalize'>"+part+"</td><td style='text-transform:capitalize'>"+color_name+"</td><td class='qnty'>"+quantity+"</td></tr>";
