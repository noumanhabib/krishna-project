                                       ...
                                       @if(!empty($data))
                                           @foreach ($data as $row)
                                            <tr>
												...
												@if(Helper::actionPermission())
												<td>
                                                <!--<td><a href='{{url("edit_sparepart")}}/{{$row['id']}}'><i class='fa fa-edit text-danger mr-2'></i></a> -->
                                                <!--/ <a href='#'  data-toggle='modal' data-target='#DeleteModal' onclick='delete_data("{{$row['sku_id']}}")'><i class='fa fa-trash text-danger mr-2'></i>Delete</a>-->
                                                </td>
												@endif
                                            </tr>
                                          @endforeach
