			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<a href="{{url('add-status')}}"><button class="btn btn-primary button_right" id="add_category_btn">+ Add Status </button></a> 
						@endif
					</div>
...
$(document).ready(function () {     
	var oTable = $('#dataTableID').DataTable({
		...
		"rowCallback": function (nRow, aData, iDisplayIndex) {
			...
			var actionBtn = '<a href="{{url('edit-status')}}/'+aData.id+'" ><i class="fa fa-edit text-primary mr-2"></i></a> &nbsp;&nbsp;';
