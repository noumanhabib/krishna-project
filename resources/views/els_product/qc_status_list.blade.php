...
<div id="page-wrapper" >
	 <div class="header"> 
		<h1 class="page-header">
			 <small>QC Status List</small>
		</h1>
		<ol class="breadcrumb">
			  <li><a href="{{url('/home')}}">Home</a></li>
			  <li class="active">QC Satus</li>
		</ol>     
	 </div>
	 <div id="page-inner">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<a href="{{url('add-qc-status')}}"><button class="btn btn-primary button_right" id="add_category_btn">+ Add Status </button></a> 
						@endif
					</div>
...
$(document).ready(function () {     
	var oTable = $('#dataTableID').DataTable({
		...
		"rowCallback": function (nRow, aData, iDisplayIndex) {
			...
			var actionBtn = '<a href="{{url('edit-qc-status')}}/'+aData.id+'" ><i class="fa fa-edit text-primary mr-2"></i></a> &nbsp;&nbsp;';
