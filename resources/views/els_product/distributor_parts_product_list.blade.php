			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading d-flex">
					   ...
					   <div class="d-flex">
				<form method="POST" action="https://renewhub.controlz.world/exportdistributor/" accept-charset="UTF-8" class="form-horizontal" role="form"><input name="_token" type="hidden" value="p2oJkaKaV0RbCCis1mG9PnkAlXqjIqk2q854aT1q">
							<a href="javascript:;"><button class="btn btn-info" type="submit">Export</button></a> &nbsp;&nbsp;
							</form>
					       
						<a href="{{url('distributor_product_part')}}"><button class="btn btn-primary button_right" id="add_category_btn">+ Distribution List </button></a> 
					  </div>							
					</div>
...
<div class="modal fade" id="editModel" tabindex="-1" role="dialog" aria-labelledby="ViewDetailModal">
    <div class="modal-dialog modal-dialog-centered modal-min" role="document">
        ...
        <center><h3>Status Log Details</h3></center>
      </div>
...
<div id="importModel" class="modal fade" role="dialog">
    ...
    <!-- Modal content-->
		...
		<div class="modal-body">
			{!! Form::open(['url' =>'upload-distributor-allocation-enginner', 'class' => 'form-horizontal', 'id' => 'save-form', 'role' => 'form','files'=>'true']) !!}
...
$(document).ready(function () {     
	var oTable = $('#dataTableID').DataTable({
		...
		'serverSide': true,		
		"ajax":{
			"url": "{{url('part-distributor-product-list')}}"
		}, 	
		"columns": [
			{ data: "id" },
			{ data: "barcode" },
