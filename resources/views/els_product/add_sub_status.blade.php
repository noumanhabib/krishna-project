...
<div id="page-wrapper" >
         <div class="header"> 
			<h1 class="page-header">
				 <small>Add Sub Status</small>
			</h1>
			<ol class="breadcrumb">
				  <li><a href="{{url('/home')}}">Home</a></li>
				  <li><a href="{{url('sub-status')}}">Sub Status List</a></li>
				  <li class="active">Add Sub Status</li>
			</ol>     
         </div>
         <div id="page-inner">
            <div class="row">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="card-title">
                                        <div class="title">Add Sub Status</div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                {!! Form::select('status_id',$status,'',['class' => 'form-control','required', 'id'=>'status_id','placeholder'=>'-Select-']) !!}  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="name"  id="name" placeholder="Enter Status Name" autocomplete="off">
                                                <span id="addramnamevalid" class="text-danger"></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
    ...
    if ($("#status_id").val().trim() && $("#name").val().trim()) {
     ...
     $.ajax({
        url: Url,
            ...
            type: "POST",
            dataType: "json",
            data:'name='+name+'&status_id='+status_id,
