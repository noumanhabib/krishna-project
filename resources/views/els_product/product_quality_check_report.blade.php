...
<div id="page-wrapper" >
	 <div class="header"> 
		<h1 class="page-header">
			<small>Product Quality Check Report List</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="{{url('/home')}}">Home</a></li>
			<li class="active">Product Quality Check Report</li>
		</ol>     
	 </div>
	 <div id="page-inner">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading d-flex">
						<div>Product Quality Check Report </div>
						<div class="d-flex">	
							<div id="reportrange" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%">
								<i class="fa fa-calendar"></i>&nbsp;
								<span></span> <i class="fa fa-caret-down"></i>
							</div>&nbsp;&nbsp;
							<a href="{{url('download-quality-check-report')}}"><button class="btn btn-primary button_right" id="add_category_btn">Export </button></a> 
						</div>
					</div>
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover">
								...
								@foreach($data as $key => $d)
									@foreach($status as $v)
										@php
											$count = Helper::getAssignedQcSystemCount($d->id,$v->id);
											$countArr[$v->id][] = $count;
											$grand_total += $count;
										@endphp 
									@endforeach	
